 ...
 * Facebook
 */
add_shortcode('social-facebook', 'social_facebook_sc');
 ...
 * Staff List
 */
add_shortcode('staff-list', 'staff_list_sc');
 ...
 */
add_shortcode('map-listing', 'map_listing_sc');
...
function client_name_sc($atts, $content = null)
{
	...
	//$email = antispambot(get_option('options_mandr_email'));
	$output = get_field('client_name', 'options');
...
{
	$website = get_field('client_website', 'options');
	ob_start();
	?>
