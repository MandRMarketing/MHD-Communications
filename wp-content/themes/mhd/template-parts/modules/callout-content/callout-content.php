...
<section <?= $section_id; ?> class="section-wrap callout-content <?= $section_classes; ?> <?= $callout_position === true ? 'callout-top' : 'callout-bottom' ?>">
    <?php if ($callout_position === true) : ?>
        <div class="callout-content__container container callout-top">
            <div class="callout-content__container__callout">
                <img src="/wp-content/themes/mhd/assets/images/callout-logo.svg" alt="MHD logo" />
                <div> <?= $callout_content ?>
                </div>
            </div>
            <div class="callout-content__container__content">
                <?= $bottom_content ?>
            </div>
        </div>
    <?php else : ?>
        <div class="callout-content__container container callout-bottom">
            <div class="callout-content__container__content">
                <?= $bottom_content ?>
            </div>
            <div class="callout-content__container__callout">
